...
import com.example.azeee.mob.Chat;
import com.example.azeee.mob.GetSet;
import com.example.azeee.mob.GetUsersContract;
import com.example.azeee.mob.GetUsersPresenter;
import com.example.azeee.mob.ItemClickSupport;
import com.example.azeee.mob.R;
import com.example.azeee.mob.UserListingRecyclerAdapter;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.activity_main4, container, false);
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
       Chat.startActivity(getActivity(),
